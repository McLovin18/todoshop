    ...
    try {
      ...
      try {
        ...
        if (!emprendedorSnapshot.empty) {
          ...
          const emprendedorRef = doc(db, "emprendedores", emprendedorDoc.id);
          await updateDoc(emprendedorRef, { photoURL: url });
        }
      } catch (firestoreError) {
        console.error("Error al actualizar photoURL en Firestore:", firestoreError);
        // No fallar completamente si Firestore falla, ya que Auth ya se actualizó
      }
    } catch (e) {
